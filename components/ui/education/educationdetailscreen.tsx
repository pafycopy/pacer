      ...
      >
          ...
          >
            ...
            <View style={styles.cardLessonInner}>
              ...
              <View style={styles.cardLessonText}>
                ...
                <Text style={styles.cardLessonTitle}>
                  {lesson.title}
                </Text>

                {lesson.subtitle ? (
                  <Text style={styles.cardLessonSubtitle}>
                    {lesson.subtitle}
                  </Text>
                ) : null}

                <Text style={styles.cardLessonDesc}>
                  {lesson.description}
                </Text>
        ...
        {isWarmup && topic.lessons.map((lesson) => (
          ...
          <ExerciseCard
            ...
            onPress={() => {
              console.log('Open Warm Up Video');
            }}
          />
        ...
        {isStrength && topic.lessons.map((lesson) => (
          ...
          <ExerciseCard
            ...
            thumbnail={lesson.thumbnail}
            onPress={() => {
              console.log('Open Strength Video');
            }}
          />
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerText}>
            Kamu selalu bisa kembali dan
            tinjau kembali panduan ini.
          </Text>

        </View>

        <Text style={styles.footerSub}>
          Praktekan secara rutin agar
          teknik dan kualitas lari Anda
          semakin baik.
        </Text>
